...
# **subscriptionsGet**
> \Swagger\Client\Model\InlineResponse20035 subscriptionsGet($page)
...
$body = new \Swagger\Client\Model\Body8(); // \Swagger\Client\Model\Body8 | Subscription details
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body8**](../Model/Body8.md)| Subscription details |
...
> \Swagger\Client\Model\InlineResponse20036 subscriptionsSubscriptionIdDelete($subscription_id)
