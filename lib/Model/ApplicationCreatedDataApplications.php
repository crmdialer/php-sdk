<?php
/**
 * ApplicationCreatedDataApplications
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ApplicationCreatedDataApplications Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplicationCreatedDataApplications implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicationCreated_data_applications';
...
'finished_by' => '\Swagger\Client\Model\ApplicationCreatedDataFinishedBy'    ];
...
'finished_by' => 'getFinishedBy'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['finished_by'] = isset($data['finished_by']) ? $data['finished_by'] : null;
    }
     ...
     * Sets submission_id
     *
     * @param string $submission_id Application submission identifier
     *
     * @return $this
     */
     ...
     * Sets finished_at
     *
     * @param \DateTime $finished_at Date and time of submission (ISO 8601)
     *
     * @return $this
     */
     ...
     * Gets finished_by
     *
     * @return \Swagger\Client\Model\ApplicationCreatedDataFinishedBy
     */
    public function getFinishedBy()
    {
        return $this->container['finished_by'];
    }

    /**
     * Sets finished_by
     *
     * @param \Swagger\Client\Model\ApplicationCreatedDataFinishedBy $finished_by finished_by
     *
     * @return $this
     */
    public function setFinishedBy($finished_by)
    {
        $this->container['finished_by'] = $finished_by;
