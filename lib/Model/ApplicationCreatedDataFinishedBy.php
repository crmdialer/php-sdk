<?php
/**
 * ApplicationCreatedDataFinishedBy
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ApplicationCreatedDataFinishedBy Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplicationCreatedDataFinishedBy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicationCreated_data_finishedBy';
...
'user_class' => 'getUserClass'    ];
     ...
     * Sets user_class
     *
     * @param string $user_class Submitter's User CLass
     *
     * @return $this
     */
