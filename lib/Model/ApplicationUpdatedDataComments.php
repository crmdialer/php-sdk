<?php
/**
 * ApplicationUpdatedDataComments
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ApplicationUpdatedDataComments Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ApplicationUpdatedDataComments implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ApplicationUpdated_data_comments';
...
'text' => 'getText'    ];
     ...
     * Sets date
     *
     * @param \DateTime $date Date and time of comment (ISO 8601)
     *
     * @return $this
     */
