<?php
/**
 * LeadCreatedEventInfoDataLeadCreatedBy
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * LeadCreatedEventInfoDataLeadCreatedBy Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LeadCreatedEventInfoDataLeadCreatedBy implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LeadCreatedEventInfo_data_lead_createdBy';
...
'user_class' => 'getUserClass'    ];
     ...
     * Sets user_class
     *
     * @param string $user_class Author's User CLass
     *
     * @return $this
     */
