...
'events' => 'getEvents'    ];
    ...
    const EVENTS_CREATED = 'lead.created';
const EVENTS_DELETED = 'lead.deleted';
const EVENTS_RESTORED = 'lead.restored';
const EVENTS_STATUSUPDATED = 'lead.status.updated';
const EVENTS_NOTEADDED = 'lead.note.added';
    ...
    public function getEventsAllowableValues()
    {
        return [
            self::EVENTS_CREATED,
self::EVENTS_DELETED,
self::EVENTS_RESTORED,
self::EVENTS_STATUSUPDATED,
self::EVENTS_NOTEADDED,        ];
    }
