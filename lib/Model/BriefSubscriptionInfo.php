...
const EVENTS_APPLICATIONCREATED = 'application.created';
const EVENTS_APPLICATIONUPDATED = 'application.updated';
...
self::EVENTS_APPLICATIONCREATED,
self::EVENTS_APPLICATIONUPDATED,        ];
    }
