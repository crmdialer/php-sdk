...
class LeadsApi
{
     ...
     *
     * @param  \Swagger\Client\Model\Body3 $body Create a lead appointment (required)
     * @param  int $lead_id Lead Id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create a lead note
     *
     * @param  \Swagger\Client\Model\Body2 $body Create a lead note (required)
     * @param  int $lead_id Lead Id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create a lead task
     *
     * @param  \Swagger\Client\Model\Body4 $body Create a lead task (required)
     * @param  int $lead_id Lead Id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
