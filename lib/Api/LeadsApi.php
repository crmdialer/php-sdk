...
class LeadsApi
{
     ...
     */
    public function leadsGet($page = null, $per_page = null, $sort_by = null, $sort_dir = 'asc', $group = null, $campaign = null, $source = null, $status = null, $category = null, $user = null, $date_filter = null, $start_date = null, $end_date = null, $email = null)
    {
        list($response) = $this->leadsGetWithHttpInfo($page, $per_page, $sort_by, $sort_dir, $group, $campaign, $source, $status, $category, $user, $date_filter, $start_date, $end_date, $email);
        return $response;
    }
     ...
     */
    public function leadsGetWithHttpInfo($page = null, $per_page = null, $sort_by = null, $sort_dir = 'asc', $group = null, $campaign = null, $source = null, $status = null, $category = null, $user = null, $date_filter = null, $start_date = null, $end_date = null, $email = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->leadsGetRequest($page, $per_page, $sort_by, $sort_dir, $group, $campaign, $source, $status, $category, $user, $date_filter, $start_date, $end_date, $email);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadsGetAsync($page = null, $per_page = null, $sort_by = null, $sort_dir = 'asc', $group = null, $campaign = null, $source = null, $status = null, $category = null, $user = null, $date_filter = null, $start_date = null, $end_date = null, $email = null)
    {
        return $this->leadsGetAsyncWithHttpInfo($page, $per_page, $sort_by, $sort_dir, $group, $campaign, $source, $status, $category, $user, $date_filter, $start_date, $end_date, $email)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function leadsGetAsyncWithHttpInfo($page = null, $per_page = null, $sort_by = null, $sort_dir = 'asc', $group = null, $campaign = null, $source = null, $status = null, $category = null, $user = null, $date_filter = null, $start_date = null, $end_date = null, $email = null)
    {
        $returnType = '\Swagger\Client\Model\InlineResponse200';
        $request = $this->leadsGetRequest($page, $per_page, $sort_by, $sort_dir, $group, $campaign, $source, $status, $category, $user, $date_filter, $start_date, $end_date, $email);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function leadsGetRequest($page = null, $per_page = null, $sort_by = null, $sort_dir = 'asc', $group = null, $campaign = null, $source = null, $status = null, $category = null, $user = null, $date_filter = null, $start_date = null, $end_date = null, $email = null)
    {
     ...
     *
     * @param  \Swagger\Client\Model\Body5 $body Create a lead appointment (required)
     * @param  int $lead_id Lead Id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create a lead note
     *
     * @param  \Swagger\Client\Model\Body4 $body Create a lead note (required)
     * @param  int $lead_id Lead Id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Update a lead
     *
     * @param  \Swagger\Client\Model\Body1 $body Lead changes (send only fields you want to change) (required)
     * @param  int $lead_id Lead Id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * Create a lead
     *
     * @param  \Swagger\Client\Model\Body $body Lead details (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
